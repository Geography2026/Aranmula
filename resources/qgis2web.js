...
map.getView().fit([8530760.675265, 1038422.528970, 8538722.808609, 1044115.613467], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">ARANMULA WEB MAP</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (46 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'This website is a part of educational training';
            }
